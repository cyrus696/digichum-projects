...
const Newsletter = () => {
    return (
        <section id="Contact-us" className="relative min-h-[600px] flex justify-center items-center text-center py-[80px] px-5 bg-[#0f1311]">
            <div className="w-full max-w-[800px]">
                ...
                <form className="flex justify-center gap-5 mb-[30px] flex-wrap">
                    <input type="text" placeholder="Name*" required className="p-[14px_20px] rounded-[20px] border-none text-sm outline-none min-w-[200px] bg-white text-black" />
                    <input type="email" placeholder="Email*" required className="p-[14px_20px] rounded-[20px] border-none text-sm outline-none min-w-[200px] bg-white text-black" />
                    <input type="tel" placeholder="Phone" className="p-[14px_20px] rounded-[20px] border-none text-sm outline-none min-w-[200px] bg-white text-black" />
                </form>
